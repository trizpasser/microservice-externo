...
class TestMain(unittest.TestCase):
    ...
    def test_enviar_email_route(self, mock_envia_email):
        mock_envia_email.status_code = 200
        ...
        with app.test_client() as client:
            ...
            self.assertEqual(response.status_code, mock_envia_email.status_code)
    ...
    def test_processar_cobrancas_em_fila_route(self, mock_processa_cobrancas_pendentes):
        ...
        with app.test_client() as client:
            response = client.post('/processaCobrancasEmFila', headers={"Content-Type": "application/json"})
